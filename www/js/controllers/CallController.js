...
.controller('CallController', function($scope, $state, $timeout, $ionicModal, SocketService, $rootScope, $ionicPlatform) {
	var r = new Random();
	...
	SocketService.on('connect', function() {
		SocketService.emit('login', {'id': id, platform: ionic.Platform.platform()});
	...
	$ionicPlatform.on('resume', function() {
		console.log('query users on resume');
